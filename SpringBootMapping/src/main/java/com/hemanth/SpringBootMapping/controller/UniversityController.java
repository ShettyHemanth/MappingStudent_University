...
public class UniversityController
{
    ...
    public University addingUniversity(@RequestBody University university)
    {
    ...
    public List<University> gettingUniversity()
    {
    ...
    public String upUniversity(@RequestBody University s)
    {
